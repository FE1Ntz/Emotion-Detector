...
for imagePath in sorted(list(paths.list_images(args['dataset']))):
    ...
    label = imagePath.split(os.path.sep)[-2] # C:\Users\Balaji\Documents\Smile-Detector\SMILEs\positives\3.jpg
    labels.append(label) 
...
model = LeNet.build(width=28, height=28, depth=1, classes=7)
